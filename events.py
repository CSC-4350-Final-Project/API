...
def get_event_detail(id):
    ...
    event_images=event_detail['images'][0]['url']


    event_place_line1=event_detail['_embedded']['venues'][0]['address']['line1']

    event_place_city=event_detail['_embedded']['venues'][0]['city']['name']

    event_place_state=event_detail['_embedded']['venues'][0]['state']['stateCode']

    event_place_postalCode=event_detail['_embedded']['venues'][0]['postalCode']

    event_place= ", ".join([event_place_line1, event_place_city, event_place_state, event_place_postalCode])
